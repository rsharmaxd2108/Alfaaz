...
<head>
    ...
    <title>Sign In to Your Poet Desk — Alfaaz</title>
    <meta name="description" content="Sign in to Alfaaz to compose, draft, and publish timeless Urdu and Hindi couplets.">
    ...
    <style>
        *, *::before, *::after {
        ...
        /* Checkbox Row & Custom Circular Checkbox */
        .checkbox-row {
            margin: 6px 0 22px;
            text-align: left;
        }
        ...
        <div class="layered-card-wrap">
            ...
            <div class="card-layer-front">
                <div class="auth-header">
                    ...
                    <p class="brand-subtitle-serif">Where every word finds its soul</p>
                </div>
                ...
                @if (session('status'))
                    <div class="auth-status-banner" style="background: #F0F9F4; border: 1px solid #C3E6CB; color: #2E9D61; padding: 10px 14px; border-radius: 12px; font-size: 13px; margin-bottom: 16px;">
                        {{ session('status') }}
                    </div>
                @endif
                ...
                <form class="auth-form" method="POST" action="{{ route('login.post') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input type="password" id="passwordInput" name="password" class="form-input" placeholder="Enter your password" maxlength="128" required autocomplete="current-password">
                    ...
                    <div class="checkbox-row">
                        <label class="custom-checkbox-wrap">
                            <input type="checkbox" id="rememberCheck" name="remember" value="1" class="custom-checkbox-input" {{ old('remember', true) ? 'checked' : '' }}>
                ...
                <div class="auth-card-switch">
                    <span>New to Alfaaz?</span>
                    <a href="{{ route('signup') }}">Create account</a>
                </div>

                <p class="auth-guarantee">
