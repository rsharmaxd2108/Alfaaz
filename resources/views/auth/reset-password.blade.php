...
<head>
    ...
    <title>Set New Password — Alfaaz</title>
        ...
        <div class="layered-card-wrap">
            ...
            <div class="card-layer-front">
                <div class="auth-header">
                    ...
                    <p class="brand-subtitle-serif">Create a new passphrase</p>
                </div>
                ...
                <form class="auth-form" method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            >
                            <button type="button" class="btn-toggle-password" onclick="togglePasswordVisibility('passwordInput', 'eyeIcon1')" aria-label="Toggle password visibility">
                                <svg id="eyeIcon1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="18" height="18">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                    <circle cx="12" cy="12" r="3"></circle>
                                </svg>
                            </button>
                        </div>
                        <p class="password-hint">Must contain at least 8 characters, with letters and numbers.</p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-container">
                            ...
                            <input 
                                ...
                                autocomplete="new-password"
                            >
                            <button type="button" class="btn-toggle-password" onclick="togglePasswordVisibility('confirmPasswordInput', 'eyeIcon2')" aria-label="Toggle confirm password visibility">
                                <svg id="eyeIcon2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="18" height="18">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                    <circle cx="12" cy="12" r="3"></circle>
                                </svg>
                            </button>
